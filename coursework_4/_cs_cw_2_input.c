/***
 ***  generated by CSeq [ 0000 / 0000 ] 2026-05-06 18:51:42
 ***
 ...
 ***
 ***  params:
 ***    -i /Users/miadark/Projects/COMP63342-Software_Security/coursework_4/cw_2_input.c --rounds 2 --unwind 1 --backend CBMC-EXT
 ***
 ***  modules:
 ***    7C56 workarounds ()
 ...
 ***    510B feeder (backend time llvm depth slevel no-simplify unwind contexts unwind 32 show-backend-output extrargs from to)
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {5, 5, 4};
...
IF(1,0,tt1_0_1)
                                   ...
                                   static int __cs_local_t1_a1;
                                   
                                   static int *__cs_local_t1_aptr1;
                                   
tt1_0_1: IF(1,1,tt1_0_2)
                                   
                                   __cs_local_t1_aptr1 = ((int *) __cs_param_t1_arg);
                                   
tt1_0_2: IF(1,2,tt1_0_3)
                                   
                                   __cs_local_t1_a1 = (* __cs_local_t1_aptr1);
...
tt1_0_4: IF(1,4,tt1_0_5)
                                   ...
                                   assert((__cs_local_t1_a1 == 10) && (g == 0));
...
IF(2,0,tt2_0_1)
                                   ...
                                   static int __cs_local_t2_a2;
                                   
                                   static int *__cs_local_t2_aptr2;
                                   
tt2_0_1: IF(2,1,tt2_0_2)
                                   
                                   __cs_local_t2_aptr2 = ((int *) __cs_param_t2_arg);
                                   
tt2_0_2: IF(2,2,tt2_0_3)
                                   
                                   __cs_local_t2_a2 = (* __cs_local_t2_aptr2);
                                   
tt2_0_3: IF(2,3,tt2_0_4)
                                   
                                   g = (0);
                                   
                                   assert(__cs_local_t2_a2 == 20);
...
IF(0,0,tmain_1)
                                   ...
                                   __cs_init_scalar(& __cs_local_main_id1, sizeof(cspthread_t));
                                   
                                   static cspthread_t __cs_local_main_id2;
                                   __cs_init_scalar(& __cs_local_main_id2, sizeof(cspthread_t));
                                   
                                   static int __cs_local_main_arg1;
                                   __cs_local_main_arg1 = (10);
                                   
                                   static int __cs_local_main_arg2;
                                   __cs_local_main_arg2 = (20);
                                   
                                   pthread_create_2(& __cs_local_main_id1, 0, t1_0, & __cs_local_main_arg1, 1);
                                   
tmain_1: IF(0,1,tmain_2)
                                   
                                   pthread_create_2(& __cs_local_main_id2, 0, t2_0, & __cs_local_main_arg2, 2);
